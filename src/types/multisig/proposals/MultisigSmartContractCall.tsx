  ...
  description() {
    switch (this.functionName) {
      ...
      case ExternalContractFunction.ISSUE_NON_FUNGIBLE: {
        ...
        return (
          <IssueNftCollectionProposalPresentation parsedArgs={parsedArgs} />
        );
      }
      case ExternalContractFunction.ISSUE_SEMI_FUNGIBLE: {
        const parsedArgs = new ArgumentsParser().parseArguments(
        ...
        return (
          <IssueSftCollectionProposalPresentation parsedArgs={parsedArgs} />
        );
      }
      case ExternalContractFunction.ESDT_NFT_CREATE: {
        const parsedArgs = new ArgumentsParser().parseArguments(
      ...
      case ExternalContractFunction.AUCTION_TOKEN: {
        const parsedArgs = new ArgumentsParser().parseArguments(
          ExternalContractFunction.AUCTION_TOKEN,
          this.args,
        );
