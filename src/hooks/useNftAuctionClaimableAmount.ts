...
import {
  ClaimableRoyaltiesReturnType,
  queryClaimableRoyalties,
} from 'src/contracts/xSpotlightContract';
import { currentMultisigContractSelector } from 'src/redux/selectors/multisigContractsSelectors';

export const useNftAuctionClaimableAmount = () => {
  const [claimableAmountResult, setClaimableAmountResult] =
    useState<ClaimableRoyaltiesReturnType | null>(null);
