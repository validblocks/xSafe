    ...
    <Box>
      ...
      {hasTransaction && hasAction ? (
        ...
        >
          ...
          >
            <TransactionSummary transaction={transaction} action={action} />
          </TransactionAccordionSummary>

          <AccordionDetails sx={{ padding: '0', border: 'none !important' }}>
        ...
        <Box pt="14px" minWidth={'500px'}>
          <NoActionsOverlay
            message={t('No UI provided for the selected app')}
          />
        </Box>
      )}
    </Box>
