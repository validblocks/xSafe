...
const ActiveDelegationsTable = ({
    ...
    () => [
      {
        ...
        renderCell: (params: GridRenderCellParams<IProviderColumn>) => (
          <ProviderColumn
            withAPR
            columnData={params.value as IProviderColumn}
          />
        ),
      },
      {
        ...
        renderCell: (params: GridRenderCellParams<IDelegatedColumn>) => (
          <DelegatedColumn
            columnData={params.value ?? { delegatedAmount: '0' }}
          />
        ),
      },
      {
        ...
        renderCell: (params: GridRenderCellParams<IClaimableRewardsColumn>) => (
          <ClaimableRewardsColumn
            columnData={params.value as IClaimableRewardsColumn}
          />
        ),
      },
      {
  ...
  return (
    <Box sx={{ padding: maxWidth600 ? '0 0 55px 0' : '0 !important' }}>
      {maxWidth600 ? (
