...
import ChangeOwnerModalContent from 'src/components/Modals/MemberActions/ChangeOwnerModalContent';
import { currentMultisigContractSelector } from 'src/redux/selectors/multisigContractsSelectors';
import EditOwner from '../MemberActions/EditOwner';
  ...
  const getModalActions = () => {
    ...
    return (
      <Box className="modal-action-btns" sx={{ mt: '24px !important' }}>
        <MainButton onClick={handleClose} sx={{ boxShadow: 'none !important' }}>
          {t('Cancel')}
        </MainButton>
        <MainButtonNoShadow
