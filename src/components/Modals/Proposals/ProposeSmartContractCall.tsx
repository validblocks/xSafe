...
import MultisigDetailsContext from 'src/contexts/MultisigDetailsContext';
...
const ProposeSmartContractCall = ({
  ...
  useEffect(() => {
    refreshProposal();
  }, [formik.values, formik.errors, refreshProposal]);
    ...
    <Styled.SelectProposalTypesModalContainer>
      ...
      {functionName?.length > 0 && (
        <Box>
          ...
          <MainButton
            sx={{ width: '100%', mb: '10px !important', mt: '5px' }}
